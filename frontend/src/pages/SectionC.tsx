...
import { generateSectionC, getCInterview, regenerateSectionCField } from "../api/client";
import { apiLogger } from "../api/client";
import { InterviewCard } from "../components/InterviewCard";
import { LoadingSpinner } from "../components/LoadingSpinner";
import { PageFrame } from "../components/PageFrame";
import { SectionCResult } from "../components/ResultDisplays/SectionCResult";
      ...
      footer={
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            disabled={!dataC || Object.keys(dataC).length === 0}
      ...
      <div className="space-y-5">
          ...
          <button
            ...
            onClick={async () => {
              try {
                ...
                const finalData = response.data_c || response.data || response;
                apiLogger.info("Section C: generate response", { keys: Object.keys(finalData || {}) });
                setDataC(finalData || {});
              } catch (error) {
        ...
        {dataC && Object.keys(dataC).length > 0 && (
          <div className="rounded-3xl border border-stone-200 bg-stone-50 p-6 space-y-6">
              ...
              <SectionCResult
                ...
                onRegenerate={async (key, label) => {
                  try {
                    ...
                    const resp = await regenerateSectionCField(brandInfo, context, key);
            ...
            {/* Regen Modal UI가 필요한 경우 여기에 추가 구현 */}
          </div>
        )}
      </div>
    </PageFrame>
