...
echo ""
echo "개발 서버 시작:"
echo "  터미널 1: cd backend && python -m uvicorn main:app --reload --host 0.0.0.0 --port 8000"
echo "  또는: python -m uvicorn main:app --app-dir backend --reload --host 0.0.0.0 --port 8000"
